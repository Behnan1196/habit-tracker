...
export function PlannerShell({ user }: { user: User }) {
  ...
  async function addLibraryItemToAgenda(item: ItemRow) {
    ...
    setPreferredSlotId(null); setPreferredBlockId(null); setWorkspace('agenda'); window.history.replaceState(null, '', '/'); await loadData();
  }
